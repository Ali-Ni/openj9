...
public class BCNames {
	...
	public static final int JBiloadw = 205;
	public static final int JBlloadw = 206;
	public static final int JBfloadw = 207;
	public static final int JBdloadw = 208;
	public static final int JBaloadw = 209;
	public static final int JBistorew = 210;
	public static final int JBlstorew = 211;
	public static final int JBfstorew = 212;
	public static final int JBdstorew = 213;
	public static final int JBastorew = 214;
	public static final int JBiincw = 215;
	public static final int JBaload0getfield = 217;
	public static final int JBnewdup = 218;
